// Shared stories data used by both website and dashboard
export const storiesData = [
  {
    ...
    content: "Nakang's family had never sent a child to school before. As traditional cattle herders in the Didinga Hills, education was seen as unnecessary. When our funds helped make bricks for the first classroom in her village, her parents were hesitant. But Nakang's determination changed everything. She walks 3 kilometers each day through the rugged hills to attend classes, and her grades are exceptional. 'I want to become a doctor to help my community,' she says with confidence that inspires everyone around her.",
    author: "Mary Loboi",
    date: "2024-01-15",
    location: "Didinga Hills, Lotukei, South Sudan",
    category: "students",
  ...
  },
  {
    ...
    excerpt: "Our funds helped make bricks for the first permanent classroom in the Didinga Hills, transforming education access for over 200 children.",
    content: "Before our funds helped make bricks for the first classroom, children in the Didinga Hills were learning under trees and in temporary shelters. When it rained, classes were cancelled. When it was too hot, children couldn't concentrate. The new classroom has changed everything. 'Now we can learn every day, no matter the weather,' says 12-year-old student Peter Lokang. 'I want to become a teacher so I can help other children like me.'",
    author: "Grace Nadai",
    date: "2024-01-05",
    location: "Didinga Hills, Lotukei, South Sudan",
    category: "community",
  ...
  },
  {
    ...
    excerpt: "The Didinga community has raised funds for bricks for 3 classrooms through bottle and can collection programs.",
    content: "When we couldn't afford to fund classroom construction, the Didinga community took action. They started collecting bottles and cans, selling them to recycling companies. The proceeds were used to make some of the bricks that built 3 classrooms. 'Every bottle counts,' says Didinga community leader Thomas Lokang. 'We're building our children's future one bottle at a time.' This program has created a sense of ownership and pride in the Didinga community.",
    author: "Anna Nadai",
    date: "2023-12-20",
    location: "Lotukei sub-county, Didinga Hills",
    category: "community",
