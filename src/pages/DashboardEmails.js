...
import { Mail, ExternalLink, Inbox, Shield, Info } from 'lucide-react';
            ...
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Email Management</h2>
                <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                  Access the organization's mailbox using MXroute Roundcube webmail. Use this dashboard
                  as a quick launch point while keeping all admin tools open in this tab.
                </p>
            </div>
